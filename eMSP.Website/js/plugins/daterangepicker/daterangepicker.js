...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        setOptions: function (options, callback) {
            ...
            this.timePicker = this.element[0].attributes.timePicker ? (this.element[0].attributes.timePicker.value == 'true' ? true : false) : false;
            ...
            if (typeof options.format === 'string')
                this.format = this.element[0].attributes.format ? this.element[0].attributes.format.value : 'MM/DD/YYYY';
