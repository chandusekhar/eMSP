    ...
    public static class CandidateExtensions
    {
        ...
        public static CandidateCreateModel ConvertToCandidateCreateModel(this tblCandidate data)
        {
            return new CandidateCreateModel()
            {
                ...
                CandidateFile =  data?.tblCandidateFiles?.Where(a => a.IsActive == true && a.IsDeleted == false)?.Select(a => a.tblFile?.ConvertToCandidateFileModel(Convert.ToInt32(a.FileTypeID)))?.ToList(),
