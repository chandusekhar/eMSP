...
function manageExpensesController($scope, $state, $uibModal, localStorageService, configJSON, PayPeriodList, apiCall, APP_CONSTANTS, toaster, $filter, SpendCategoryList, CurrentStatusList) {
